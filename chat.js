!(function (t) {
  ...
  function (t, e, n) {
    ...
    t.exports = function (t) {
      return (
        i(f, t) || (c && i(s, t) ? (f[t] = s[t]) : (f[t] = d("Symbol." + t))),
        f[t]
      );
    };
  },
  ...
  function (t, e, n) {
    ...
    (t.exports = function (t, e, n, c) {
      ...
      "function" == typeof n &&
        ...
        (a = s(n)).source ||
          (a.source = d.join("string" == typeof e ? e : ""))),
        t !== o
          ? (f ? !p && t[e] && (l = !0) : delete t[e],
            l ? (t[e] = n) : r(t, e, n))
          : l
          ? (t[e] = n)
          : u(e, n);
        ...
        concat: function (t) {
          ...
          for (e = -1, o = arguments.length; e < o; e++)
            if (m((i = -1 === e ? u : arguments[e]))) {
              if (l + (r = a(i.length)) > 9007199254740991)
  ...
  function (t, e, n) {
    ...
    !(function () {
      var t =
        ...
        e = t
          ? "".concat("https://widget-v4.tidiochat.com/", "/dist/")
      ...
      function r(t) {
        !(function (t, e) {
          ...
          ""
            .concat(e, "/")
            .concat("1_107_0", "/static/js/widget.")
            .concat(n.h, ".js")
        );
      }
      var i = n(221).default;
          ...
          return setTimeout(function () {
            ...
            !(function (t, e, n) {
              ...
              t &&
                ...
                ((o.contentWindow.__REDUX_DEVTOOLS_EXTENSION__ =
                  window.__REDUX_DEVTOOLS_EXTENSION__),
                (o.contentWindow.__REDUX_DEVTOOLS_EXTENSION_COMPOSE__ =
                  window.__REDUX_DEVTOOLS_EXTENSION_COMPOSE__)),
                (function (t) {
                  var o = "//localhost:3000/static/js/WidgetIframe.js";
                  o = ""
                    .concat(e)
                    .concat("1_107_0", "/static/js/chunk-WidgetIframe-")
                    .concat(n.h, ".js");
                ...
                (function (t) {
                  ...
                  (n.rel = "preconnect"),
                    (n.href = "https://fonts.googleapis.com"),
                    t.head.appendChild(n);
                  var o = t.createElement("link");
                  (o.rel = "preconnect"),
                    (o.href = "https://twemoji.maxcdn.com"),
